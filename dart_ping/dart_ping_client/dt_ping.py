...
class DARTPinger:
    ...
    def send_packet(self, seq):
        ...
        # 发送数据
        self.sock.sendto(ip_header + data, (self.target_fqdn, 0))
        self.sent_count += 1
        return time.time()
    ...
    def recv_response(self):
        ...
        try:
            ...
            dst_fqdn = pkt[dart_start+3:dart_start+3+dst_len].decode()  # 目标地址
            src_len = pkt[dart_start+3+dst_len]  # 源地址长度
